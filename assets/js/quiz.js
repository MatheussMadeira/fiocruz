...
// QUIZ QUESTÃO 10
var resposta10 = "B10"; // Resposta correta
...
// QUIZ QUESTÃO 11
var resposta11 = "B11"; // Resposta correta
$("input[name=questao11]").on("click", function () {
  ...
  if (resps11.length) {
    ...
    if (value === "A11") {
      $("#A11").addClass("resposta-incorreta");
      $("#B11").removeClass("resposta-correta");
    } else if (value === "B11") {
      $("#A11").removeClass("resposta-incorreta");
      $("#B11").addClass("resposta-correta");
    }
...
// QUIZ QUESTÃO 13
var resposta13 = "B13"; // Resposta correta
$("input[name=questao13]").on("click", function () {
  ...
  if (resps13.length) {
    ...
    if (value === "A13") {
      $("#A13").addClass("resposta-incorreta");
      $("#B13").removeClass("resposta-correta");
    } else if (value === "B13") {
      $("#A13").removeClass("resposta-incorreta");
      $("#B13").addClass("resposta-correta");
    }
...
// QUIZ QUESTÃO 15
var resposta15 = "B15"; // Resposta correta
$("input[name=questao15]").on("click", function () {
  ...
  if (resps15.length) {
    ...
    if (value === "A15") {
      $("#A15").addClass("resposta-incorreta");
      $("#B15").removeClass("resposta-correta");
    } else if (value === "B15") {
      $("#A15").removeClass("resposta-incorreta");
      $("#B15").addClass("resposta-correta");
    }
